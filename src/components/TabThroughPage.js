  ...
  return (
    <div style={s.root}>
      ...
      <div>
        <ul style={s.list}>
          <li style={s.listItem}>
            &ndash; {s.code('tab', tb12)} through the page to test out the keyboard
            functionality.
          </li>
          <li style={s.listItem}>
          ...
          <li style={s.listItem}>
            &ndash; Chrome, Edge, and Firefox&#39;s default settings
            will {s.code('tab', tb12)} through everything,
            in Safari the default is {s.code('option-tab', tb12)}.
          </li>
        </ul>
      </div>
    </div>
