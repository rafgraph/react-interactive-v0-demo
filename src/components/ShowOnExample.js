      ...
      <div style={s.root}>
        ...
        <div style={s.infoBox}>
          {this.state.showInfo
            ...
            : <span style={s.subTitle}>
                {s.code('hover')}, {s.code('touchActive')}, and{' '}
                {s.code('focus')} from {s.code('tab')}
              </span>}
        </div>
        <Interactive
          as="span"
        ...
        >
          <svg
            ...
            style={s.svg}
          >
            <path d="M15.5,26.97C9.71,26.97,5,22.259,5,16.47c0-5.79,4.71-10.5,10.5-10.5S26,10.67,26,
